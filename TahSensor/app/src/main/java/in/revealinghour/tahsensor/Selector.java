...
// new changes for action bar and drawer
        ...
        if (savedInstanceState == null) {
            replaceFragment(new SonarSensor(), 0, "mac");
        }
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if (TAHble.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                final String data = intent.getStringExtra(TAHble.EXTRA_DATA).toString();
                if (fragmentNumber == 1) {
                    try {
                        SonarSensor fragment = (SonarSensor) fragmentManager.findFragmentById(R.id.content_frame);
                    ...
                    try {
                        Temperature fragment = (Temperature) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                    ...
                    try {
                        Touch fragment = (Touch) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                    ...
                    try {
                        Light fragment = (Light) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                    ...
                    try {
                        Wind fragment = (Wind) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                    ...
                    try {
                        Motion fragment = (Motion) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                    ...
                    try {
                        Rain fragment = (Rain) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }else if(fragmentNumber == 9 ){
                    try {
                        Soil fragment = (Soil) fragmentManager.findFragmentById(R.id.content_frame);
                        fragment.UpdateUI(data);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }
               // Toast.makeText(Selector.this, "data===" + data, Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//        // update selected item and title, then close the drawer
    ...
    private class DrawerItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                case 0:
                    replaceFragment(new SonarSensor(), position, "");
                    break;
                case 1:
                    replaceFragment(new Temperature(), position, "");
                    break;
                case 2:
                    replaceFragment(new Touch(), position, "");
                    break;
                case 3:
                    replaceFragment(new Light(), position, "");
                    break;
                case 4:
                    replaceFragment(new Rain(), position, "");
                    break;
                case 5:
                    replaceFragment(new Wind(), position, "");
                    break;
                case 6:
                    replaceFragment(new Motion(), position, "");
                    break;
                case 7:
                    replaceFragment(new Soil(), position, "");
                    break;
                case 8:
