 ...
 */
public class Touch extends Fragment implements View.OnClickListener {
    ImageView setting;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.touch_sensor, container, false);
        setting = (ImageView) view.findViewById(R.id.pinsetting);
        pinsetting = (FrameLayout) view.findViewById(R.id.frametouch);
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                Selector.activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Selector.mBluetoothLeService.getTAHTouchSensorUpdate(PinNo);
            ...
            public void run() {
                try {
                    ...
                    if (Integer.parseInt(rawData)==1){
                        txtReading.setText("Touch \n Detected");
                    }else {
                        txtReading.setText("Touch Not \n Detected");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
