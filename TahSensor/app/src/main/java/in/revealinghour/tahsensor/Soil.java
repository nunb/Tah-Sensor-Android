...
/**
 * Created by adityamathur on 22/05/15.
 */
public class Soil extends Fragment implements View.OnClickListener {
    ImageView setting;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.soil_sensor, container, false);
        setting = (ImageView) view.findViewById(R.id.pinsetting);
        pinsetting = (FrameLayout) view.findViewById(R.id.framesoil);
            ...
            public void run() {
                Selector.activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Selector.mBluetoothLeService.getTAHSoilMoistureSensorUpdate(PinNo);
        ...
        Selector.activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    txtReading.setText("" + Integer.parseInt(rawData)+" %");
                } catch (Exception e) {
                    e.printStackTrace();
                }
