...
public class Light extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.light_sensor, container, false);
        setting = (ImageView) view.findViewById(R.id.pinsetting);
        pinsetting = (FrameLayout) view.findViewById(R.id.framelight);
            ...
            public void run() {
                Selector.activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Selector.mBluetoothLeService.getTAHLightSensorUpdate(PinNo);
